...
class CaveView(arcade.View):
    ...
    def on_draw(self) -> None:
        ...
        if self.game.cave.collected <= self.game.cave.to_collect:
            self.print(10, 3.5, 'GOAL')    ; self.print(10, -3.5, f'{self.game.cave.to_collect-self.game.cave.collected:02}')
        else:
            self.print(10, 3.5, 'PLUS')    ; self.print(10, -3.5, f'{self.game.cave.collected-self.game.cave.to_collect:02}')
        self.print(14, 6, 'SCR')   ; self.print(14, -6, f'{self.game.players[0].score:08}')
